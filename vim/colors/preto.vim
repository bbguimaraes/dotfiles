" Adapted from https://github.com/ewilazarus/preto
...
call s:HL('StatusLine' 	  , s:palette.white	, s:palette.gray06 , 'none'	   , 'gui_macvim')
call s:HL('StatusLineNC'  , s:palette.white	, s:palette.gray03 , 'none'	   , 'gui_macvim')
